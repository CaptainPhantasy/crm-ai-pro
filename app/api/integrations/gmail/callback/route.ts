...
export async function GET(request: Request) {
  try {
    ...
    // Get user email from Google (we'll need to call userinfo endpoint)
    // For now, we'll store tokens and fetch email later
    ...
    const providerData = {
      ...
      user_id: userId,
      provider: 'gmail',
      provider_email: '', // Will be updated after we get user info
      is_active: true,
