  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-dark-panel data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-neon-blue-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 circuit-pattern border-neon-blue-glow700/50",
          side === "right" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-dark-panel focus:ring-neon-blue-glow300 data-[state=open]:bg-dark-tertiary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none text-neon-blue-glow300">
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-neon-blue-glow100/70 text-sm", className)}
      {...props}
    />
  )
}
